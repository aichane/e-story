    ...
    <nav class="navbar navbar-default navbar-fixed-default navbar-inverse" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-topbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${model.Lesson.get_class_url(ctx)}">${_('Lessons')}</a></li>
            </ul>
            <%self:topbar_user/>
        </div>
    </nav>
...
%>\
    % if is_admin or user is not None:
        ...
        % endif
                        <li><a href="${model.Item.get_admin_class_url(ctx)}">${_('Items')}</a></li>
                        <li><a href="${model.Lesson.get_admin_class_url(ctx)}">${_('Lessons')}</a></li>
        % if is_admin:
