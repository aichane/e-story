...
def load_environment(global_conf, app_conf):
    ...
    conf = estory.conf  # Empty dictionary
    ...
    conf.update(conv.check(conv.struct(
        {
            ...
            'cookie': conv.default('e-story'),
            'database': conv.default('estory'),
...
#                ),
    ...
    if not errorware['debug']:
        ...
        errorware['error_subject_prefix'] = conf.get('error_subject_prefix', 'e-story Error: ')
